...
const Fuzzers = .{
    .binding = @import("binding_fuzz.zig"),
    .buffer_circular = @import("buffer/circular_fuzz.zig"),
    .buffer_rolling = @import("buffer/rolling_fuzz.zig"),
    .keycode = @import("platform/keycode_fuzz.zig"),
    .pipeline = @import("pipeline_fuzz.zig"),
    .registry_key = @import("registry/key_fuzz.zig"),
    .state = @import("state_fuzz.zig"),
    .canary = {},
    .smoke = {},
};
